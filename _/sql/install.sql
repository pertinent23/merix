#CREATE DATABASE IF NOT EXISTS merix CHARACTER SET utf8 COLLATE utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS POSTS(
    ...
    updatedAt DATETIME NOT NUll,
    PRIMARY KEY(post_id),
    FOREIGN KEY(post_type_id) REFERENCES POSTS_TYPE(post_type_id) ON DELETE CASCADE
);
